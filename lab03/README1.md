...
![](README1_files/figure-gfm/unnamed-chunk-19-1.png)<!-- -->

``` r
hist(met$temp)
```

![](README1_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->

``` r
hist(met$wind.sp)
```

![](README1_files/figure-gfm/unnamed-chunk-20-2.png)<!-- -->
...
![](README1_files/figure-gfm/unnamed-chunk-23-1.png)<!-- -->
...
![](README1_files/figure-gfm/unnamed-chunk-24-1.png)<!-- -->

``` r
plot(elev$date, elev$wind.sp, type='l')
```

![](README1_files/figure-gfm/unnamed-chunk-24-2.png)<!-- -->
