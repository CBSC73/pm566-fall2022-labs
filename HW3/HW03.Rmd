...
pubmedabs %>%
  ...
  geom_col()
```
### _Here are the top 20 words in the abstracts. "COVID" and "19" are at the top of the list, thus likely articles about COVID are the most common abstracts. "Cancer" and "prostate" are also on the list and most likely the second most common articles after COVID._ 
